...
?>
    ...
    <head>
        ...
        <script type="text/javascript" src="scripts/readfavbooks.js"></script>
        ...
        ?>
            ...
            <section class="features16 cid-r4GnfJlnlP mbr-parallax-background" id="features16-r">
                <div class="container align-center">
                    ...
                    <h3 class="pb-5 mbr-section-subtitle mbr-fonts-style mbr-light display-4">Welcome to your shelf</h3>
                    <div class="row" id="shelf" style="width:100%; padding:1em;">
